			...
			<div class="col-8">
				<div class="row">
					...
					<div class="col-10">
						...
						<!-- 회원정보 -->
						<table class="table table-hover" "width="820px;" height="350px;"
										...
										<div id="i2" style="display: none;">
											<div>
												<input type="text" name="userTel" id="userTel"
													value="<%=mdto.getUserTel()%>">
											</div>
											<br> <input type="submit"
												class="btn btn-outline-primary btn-sm" value="확인"> <input
												type="button" class="btn btn-outline-primary btn-sm"
												value="취소" onclick="func1();">
						...
						<h3>비밀번호 변경</h3>
						<br>
						<table class="table" width="840px;" height="100px;"
							...
							<tr>
								...
								<td>
									<button type="button" class="primary-btn look-btn"
										style="background-color: #B0BCC2;" onclick="func1();">변경하기</button>
								</td>
						...
						<fieldset style="border: 3px solid #EAEAEA; padding: 10px;">
							...
							<form>
								...
								건성 <input type="radio" name="skinType" value="중성"> 중성 <input
								...
								<input type="radio" name="skinTrouble" value="아토피" checked>
								아토피 <input type="radio" name="skinTrouble" value="민감성">
								민감성 <input type="radio" name="skinTrouble" value="해당없음">
								해당없음
								...
								<input type="radio" name="skinTrouble" value="민감성" checked>
								민감성 <input type="radio" name="skinTrouble" value="해당없음">
								해당없음
								...
								<input type="radio" name="skinTrouble" value="해당없음" checked>
								해당없음
								<%} %>
							</form>
							<br>
